...
$submit = $_POST['submit'];
$input="insert into barang(kode_barang, 
nama_barang, kode_gudang) values ('$kode_barang', '$nama_barang', '$kode_gudang')";
if($submit){
...
<tr>
<td align='center' width='20%'><b>Kode 
Barang</b></td>
<td align='center' width='30%'><b>Nama 
Barang</b></td>
<td align='center' width='10%'><b>Lokasi 
Gudang</b></td>
</tr>
<?php
$cari="select * from barang, gudang where 
barang.kode_gudang = gudang.kode_gudang";
